...
cd ../workspace/run
@echo current type:  %replace_to%
vsim  -do d5m_camera_image_file_sharp_test.tcl
cd ../../tb
@set "replace_to=blur"
@GOTO cgain
@REM --------------------------------------------
...
cd ../workspace/run
@echo current type:  %replace_to%
vsim  -do d5m_camera_image_file_blur_test.tcl
cd ../../tb
@set "replace_to=hsl"
@GOTO cgain
@REM --------------------------------------------
...
cd ../workspace/run
@echo current type:  %replace_to%
vsim  -do d5m_camera_image_file_rgb_test.tcl
cd ../../tb
...
cd ../workspace/run
@echo current type:  %replace_to%
vsim  -do d5m_camera_image_file_sobel_test.tcl
cd ../../tb
...
cd ../workspace/run
@echo current type:  %replace_to%
vsim  -do d5m_camera_image_file_emboss_test.tcl
cd ../../tb
...
cd ../workspace/run
@echo current type:  %replace_to%
vsim  -do d5m_camera_image_file_cgain_hsl_test.tcl
@GOTO wait
@REM --------------------------------------------
@REM ----------------------- ABORT
@REM --------------------------------------------
