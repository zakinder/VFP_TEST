...
log /* -r
run -all
coverage attribute -name TESTNAME -value d5m_camera_image_file_cgain_sharp_test
coverage save d5m_camera_image_file_cgain_sharp_test.ucdb
vcover report d5m_camera_image_file_cgain_sharp_test.ucdb -cvg -details
